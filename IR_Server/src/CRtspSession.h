...
#ifndef SRC_CRTSPSESSION_H_
#define SRC_CRTSPSESSION_H_
...
private:
    ...
    unsigned short m_ClientRTPPort;                           // client port for UDP based RTP transport
    unsigned short m_ClientRTCPPort;                          // client port for UDP based RTCP transport
